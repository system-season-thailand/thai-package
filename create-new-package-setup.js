...
hotelBreakFastAmountInputOptions.forEach(option => {
    option.addEventListener('click', () => {
        ...
        if (option.textContent === 'حذف') {
            ...
            lastClickedBreakFastAmountInput.value = `Including BF For ${option.textContent}`;
...
specificCarTypeInputOptions.forEach(option => {
    option.addEventListener('click', () => {
        ...
        if (option.textContent === 'حذف') {
            ...
            /* Set the input value with the clicked rooms number h3 innerText */
            specificCarTypeInput.value = 'سيارة سيدان خاصة مع سائق خاص طوال مدة الرحلة ولاتوجد أيام حرة في البرنامج';


        } else if (option.textContent === 'سيارة متوسطة') {
            /* Set the input value with the clicked rooms number h3 innerText */
            specificCarTypeInput.value = 'سيارة سيارة متوسطة خاصة مع سائق خاص طوال مدة الرحلة ولاتوجد أيام حرة في البرنامج';
