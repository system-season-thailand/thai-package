...
let allHotelDataArray = [
    /* Phuket */
    {
        ...
        hotelRoomTypes: [
            ...
            "Deluxe Suite with Whirlpool Bath Mountain View",
            "Deluxe Suite with Whirlpool Bath Seaview",
            "Deluxe Suite Pool Access Garden View",
            "Deluxe Suite Pool Access Sea View",
        ],
    },
    {
    ...
    },
    {
        ...
        hotelLocation: "Phuket",
        hotelRoomTypes: [
            "Deluxe Room (None View)",
            "Deluxe Sea View",
            "Honeymoon Sea View",
            "Grand Deluxe Sea View",
            "Romance Room Ocean View",
            "Family Sea View",
    ...
    },
    {
        ...
        hotelRoomTypes: [
            ...
            "Club Ocean View",
            "Club Ocean Front",
            "Lagoon View One BR Suite",
            "Ocean View One BR Suite",
            "Ocean Front One BR Suite",
        ],
    },
    {
    ...
    },
    {
        ...
        hotelLocation: "Phuket",
        hotelRoomTypes: [
            "YAYA Pool Suite Ocean View",
            "Ocean View Pool Suite West",
            "Ocean View Pool Suite East",
            "Ocean View Penthouse",
            "One BR Family Suite Garden View",
            "One BR Pool Villa Garden View",
            "One BR Family Suite Partial Ocean View",
            "One BR Luxury Residential Pool Villa Ocean View",
            "One BR Luxury Pool Villa Ocean View",
            "Two BR Family Suite Garden View",
            "Two BR Family Suite Ocean View",
            "Two BR Pool Villa Ocean View",
            "Two BR Luxury Pool Villa Ocean View",
            "Three BR Residence Pool Villa Partial Ocean View",
            "Three BR Residence Pool Villa Ocean View",
            "Four BR Residence Pool Villa Ocean View",
            "Four BR Luxury Residence Pool Villa Ocean View",
            "Five BR Residence Pool Villa Ocean View",
        ],
    },
    {
    ...
    },
    {
        ...
        hotelRoomTypes: [
            ...
            "Premium Garden View",
            "Premium Pool View",
            "One BR Suite Pool View",
            "Dino Suite",
            "Penthouse Terrace",
            "Two BR Family Suite",
            "Two BR Suite Garden View",
            "Duplex Pool Villa",
            "Duplex Pool Villa Sea View",
        ],
    },
    {
    ...
    },
    {
        ...
        hotelRoomTypes: [
            "Deluxe Ocean View",
            "Grand Thai Natural Ocean View",
            "Deluxe Pool Access Ocean View",
            "Grand Thai with Spa Bath & PP",
            "Family Pool Access Two BR Suite",
            "Two BR Pool Forest View",
    ...
    },
    {
        ...
        hotelLocation: "Phuket",
        hotelRoomTypes: ["Deluxe Room", "Deluxe Sea View", "Deluxe Pool Access", "Deluxe Pool Access Sea View", "Deluxe Pool Villa", "Premier Pool Villa", "Family Pool Villa Two BR"],
    },
    {
    ...
    },
    {
        ...
        hotelRoomTypes: [
            "Garden View Room",
            "Ocean View Room",
            "King Bed Plunge Pool",
            "Two BR Family Room",
            "Two BR Family Bunk Bed",
            "Ocean View Club Access",
            "King Bed Terrace Whirlpool",
            "Two BR Regency Suite",
            "King Bed Hilltop Ocean View Suite",
        ],
    },
    ...
    },
    {
        ...
        hotelLocation: "Phuket",
        hotelRoomTypes: [
            "Terrace Suites One BR",
            "Terrace Suites Two BR",
            "Terrace Suites Three BR",
            "Pool Suites One BR",
            "Pool Suites Two BR",
            "Pool Suites Three BR",
            "Pool Suites Four BR",
            "Penthouse Pool Suites One BR",
            "Penthouse Pool Suites Two BR",
            "Penthouse Pool Suites Three BR",
            "Luxury Pool Villa Three BR",
            "Luxury Pool Villa Four BR",
            "Luxury Pool Villa Five BR",
            "Luxury Pool Villa Six BR",
        ],
    },
    {
        ...
        hotelRoomTypes: [
            ...
            "Grand View Pool Villa",
            "Ocean View One BR Pool Villa",
            "Ocean View Two BR Pool Villa",
        ],
    },
    {
    ...
    },
    {
        ...
        hotelRoomTypes: [
            ...
            "Family Suite Two BR",
            "Grande Two BR Suite",
            "Family Suite Two BR Ocean View",
            "Grande Two BR Suite Ocean View",
            "Grande Two BR Suite Ocean View With Jacuzzi",
            "Grande Two BR Suite Ocean View With Plunge Pool",
            "Grande Three BR Suite Ocean View with Jacuzzi ",
            "Grande Pool Villa Two BR",
            "Grande Pool Villa Three BR",
        ],
    },
    ...
    },
    {
        ...
        hotelRoomTypes: [
            ...
            "Standard Lagoon Villa 2+2",
            "Family LAGOON Villa 4",
            "One Bedroom LAGOON Suite Villa 2+2",
            "Two Bedroom LAGOON Villa 8",
            "Two Bedroom LAGOON Suite Villa 4",
            "Sol Two Bedroom LAGOON Suite Villa 8",
        ],
    },
    {
    ...
    },
    {
        ...
        hotelRoomTypes: [
            ...
            "Premier Pool View",
            "One BR Suite Pool View",
            "One BR Residence Pool Suite",
            "Deluxe Connecting Deluxe",
            "Premier Pool View Connecting Premier Pool View",
            "One Bedroom Residence Pool Suite Connecting Premier Pool View",
        ],
    },
    {
    ...
    },
    {
        ...
        hotelRoomTypes: [
            "Deluxe King",
            "Deluxe Twin",
            "Family Two BR (2 Adult & 1 Child)",
            "Family Two BR (2 Adult & 2 Child)",
            "Executive Suite King",
            "Executive Suite Twin",
            "Executive Apartment King",
            "Executive Apartment Twin",
            "Premium Suite King",
            "Premium Suite Twin",
            "Premium Apartment King",
            "Premium Apartment Twin",
            "Sky Garden Suite King",
            "Sky Garden Suite Twin",
            "Siam Suite King",
            "Siam Suite Twin",
        ],
    },
    ...
    /* Krabi */
    {
        ...
        hotelLocation: "Krabi",
        hotelRoomTypes: ["Avani Superior Room", "Avani Superior Room", "Avani Sea View Room", "Avani Villa", "Avani Superior Sea View Room", "Avani Family Suite", "Avani Pool Villa"],
    },
    {
